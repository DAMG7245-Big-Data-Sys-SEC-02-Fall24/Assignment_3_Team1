...
def load_chat_history(document_id: str) -> list:
    """
    Load chat history from a JSON file.
    """
    history_path = os.path.join(CHAT_HISTORY_DIR, f"{document_id}_history.json")
    ...
    with open(history_path, "r") as f:
        try:
            ...
            print(f"[WARN] Invalid JSON format in {history_path}. Returning empty history.")
            return []


def save_chat_history(document_id: str, history: list):
    """
